...
//        Fragment hamada = new PlusOneFragment();
//        viewFragment.onAttach(mReactInstanceManager.getCurrentReactContext());
        getFragmentManager().beginTransaction().add(R.id.drawer_layout, viewFragment).commit();
